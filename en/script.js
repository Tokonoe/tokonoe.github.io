...
const NOP = {
	...
	recipe_box: {
		id: 'recipe_box',
		title: '&zwnj;<br>Recipe Box<br>&zwnj;'
	},
	chore_door: {
		id: 'chore_door',
		title: '&zwnj;<br>Chore Door<br>&zwnj;'
	},
	pomodoro_clock: {
		id: 'pomodoro_clock',
		title: '&zwnj;<br>Pomodoro Clock<br>&zwnj;'
	},
	calculator: {
		id: 'calculator',
		title: '&zwnj;<br>Calculator<br>&zwnj;'
	},
	drum_machine: {
		id: 'drum_machine',
		title: '&zwnj;<br>Drum Machine<br>&zwnj;'
	},
	markdown_previewer: {
		id: 'markdown_previewer',
		title: '&zwnj;<br>Markdown Previewer<br>&zwnj;'
	},
	random_quote_machine: {
		id: 'random_quote_machine',
		title: '&zwnj;<br>Random Quote Machine<br>&zwnj;'
	},
	portfolio_2: {
		id: 'portfolio_2',
	...
	technical_documentation: {
		...
		title: '&zwnj;<br>Technical Documentation<br>&zwnj;'
	},
	product_landing: {
		id: 'product_landing',
		title: '&zwnj;<br>Product Landing Page<br>&zwnj;'
	},
	survey_form: {
		id: 'survey_form',
		title: '&zwnj;<br>Survey Form<br>&zwnj;'
	}
}
...
const OP = {
	meteorites: {
		id: 'meteorites',
		title: '&zwnj;<br>Meteorites<br>&zwnj;'
	},
	shy_ghost: {
		id: 'shy_ghost',
		title: '&zwnj;<br>Shy Ghost<br>&zwnj;'
	},
	nuje: {
		id: 'nuje',
	...
	catch_me: {
		id: 'catch_me',
		title: '&zwnj;<br>Catch Me!<br>&zwnj;'
	},
	swipe: {
		id: 'swipe',
		title: '&zwnj;<br>Swipe<br>&zwnj;'
	},
	parallax: {
		id: 'parallax',
		title: '&zwnj;<br>Parallax Effect<br>&zwnj;'
	},
	iframe: {
		id: 'iframe',
	...
	password_validator: {
		...
		title: '&zwnj;<br>Password Validator<br>&zwnj;'
	},
	...
	todo: {
		id: 'todo',
		title: '&zwnj;<br>To-Do List<br>&zwnj;'
	},
	nine_pics: {
		id: 'nine_pics',
		title: '&zwnj;<br>Nine Pics<br>&zwnj;'
	},
	loving_vincent: {
		id: 'loving_vincent',
		title: '&zwnj;<br>Loving Vincent<br>&zwnj;'
	}
}
...
for(x in NOP) {
	...
	<div id="` + NOP[x].id + `" class="project">
		<a href="non_original_projects/` + NOP[x].id + `/index.html" target="_blank">` + NOP[x].title + `</a>
	</div>
	`
...
for(x in OP) {
	...
	<div id="` + OP[x].id + `" class="project">
		<a href="original_projects/` + OP[x].id + `/index.html" target="_blank">` + OP[x].title + `</a>
	</div>
	`
...
document.getElementsByClassName('project')[0].getElementsByTagName('a')[0].setAttribute('href', '/en/non_original_projects/kimha/en');