window.onload = function(){
	...
	const endGame = function() {
		...
		document.getElementById('rank').innerHTML = 'Rang: ' + rank;
		document.getElementById('best_score').innerHTML = 'Meilleur Score: ' + bestScore;
		document.getElementById('best_rank').innerHTML = 'Meilleur Rang: ' + bestRank;
